...
void TFT_display_init()
{
	...
	TFT_pushColorRep(TFT_STATIC_WIDTH_OFFSET, TFT_STATIC_HEIGHT_OFFSET, _width + TFT_STATIC_WIDTH_OFFSET -1, _height + TFT_STATIC_HEIGHT_OFFSET -1, (color_t){0,0,0}, (uint32_t)(_height*_width));
