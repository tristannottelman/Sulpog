...
#define PIN_BCKL_ON  33  	// GPIO value for backlight ON
#define PIN_BCKL_OFF 0  	// GPIO value for backlight OFF
// --------------------------------------------------------

#elif CONFIG_EXAMPLE_DISPLAY_TYPE == 2

// ** Set the correct configuration for TTGO T-Display
// ---------------------------------------------------------
...
#define TFT_STATIC_WIDTH_OFFSET 52  //portrait: 40 default: 53
#define TFT_STATIC_HEIGHT_OFFSET 40 //portrait: 53 default: 30
...
// ** Set the correct configuration for M5StickC
// ---------------------------------------------------------
#define DEFAULT_DISP_TYPE   DISP_TYPE_ILI9341
...
#define PIN_NUM_BCKL 26  	// GPIO used for backlight control
#define PIN_BCKL_ON  1  	// GPIO value for backlight ON
#define PIN_BCKL_OFF 0  	// GPIO value for backlight OFF
...
#define TFT_STATIC_X_OFFSET (orientation & 1 ? TFT_STATIC_HEIGHT_OFFSET : TFT_STATIC_WIDTH_OFFSET)
#define TFT_STATIC_Y_OFFSET (orientation & 1 ? TFT_STATIC_WIDTH_OFFSET : TFT_STATIC_HEIGHT_OFFSET)
#else
