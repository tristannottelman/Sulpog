...
void TFT_fillScreen(color_t color) {
	TFT_pushColorRep(TFT_STATIC_X_OFFSET, TFT_STATIC_Y_OFFSET, _width + TFT_STATIC_X_OFFSET -1, _height + TFT_STATIC_Y_OFFSET -1, color, (uint32_t)(_height*_width));
}
...
void TFT_setRotation(uint8_t rot) {
	...
	dispWin.x1 = TFT_STATIC_X_OFFSET;
	dispWin.y1 = TFT_STATIC_Y_OFFSET;
	dispWin.x2 = _width + TFT_STATIC_X_OFFSET -1;
	dispWin.y2 = _height + TFT_STATIC_Y_OFFSET -1;
...
{
	dispWin.x1 = x1 + TFT_STATIC_X_OFFSET;
	dispWin.y1 = y1 + TFT_STATIC_Y_OFFSET;
	dispWin.x2 = x2 + TFT_STATIC_X_OFFSET;
	dispWin.y2 = y2 + TFT_STATIC_Y_OFFSET;

	if (dispWin.x2 >= _width + TFT_STATIC_X_OFFSET) dispWin.x2 = _width + TFT_STATIC_X_OFFSET -1;
	if (dispWin.y2 >= _height + TFT_STATIC_Y_OFFSET) dispWin.y2 = _height + TFT_STATIC_Y_OFFSET -1;
